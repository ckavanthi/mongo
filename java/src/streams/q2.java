...
public class q2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "Ayushman", "jha", "comment");
        News news2 =new News(2, "Ayushman", "jha1", "budget");
        News news3 = new News(1, "Ayushman", "jha2", "comment");
        News news4 = new News(3, "Ayushman", "jha3", "budget");
        News news5 = new News(1, "Ayushman", "jha4", "comment");
        News news6 = new News(3, "Ayushman", "jha5", "budget");
        News news7 = new News(1, "Ayushman", "jha6" ,"comment");

...
public class q1 {
    ...
    {
        ArrayList<Fruit>fruits11 = new ArrayList<>();
        fruits11.add( new Fruit("Watermelon",120,50,"Yellow"));
        fruits11.add(new Fruit("Apple",80,80,"Red"));
        fruits11.add(new Fruit("Banana",110,40,"Yellow"));
        fruits11.add( new Fruit("Pear",100,30,"Yellow"));
        fruits11.add(new Fruit("Grapes",60,50,"Green"));
        reverseSort( fruits11);
        sort(fruits11);
        filterRedSortPrice(fruits11);
		return null;
